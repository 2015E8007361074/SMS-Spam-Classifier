...
input = File.open("D:/ruby/SMS-Spam-Classifier/weka6f/data_train_cut.txt")
output = File.open("D:/ruby/SMS-Spam-Classifier/weka6f/feature_Vector.txt","w")
